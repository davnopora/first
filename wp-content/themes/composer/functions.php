...
function composer_banner() {
	...
	<div class="banner" style="background-image:url(<?php
		...
		else composer_get_header_image()?>)">
			...
			<div class="wrap">
				...
				if (is_singular('post' )) {
					...
					<div class="entry-meta">
						...
						<span <?php omega_attr( 'entry-author' ); ?>><?php echo __('by ', 'composer'); the_author_posts_link();  ?> <a href="<?php echo get_author_posts_url( $post->post_author ); ?>"><?php echo get_the_author_meta( 'nickname', $post->post_author );  ?></a></span>	
